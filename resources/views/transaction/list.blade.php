...
@section('title', 'transactions transacciones')
        ...
        jQuery(document).ready(function () {
            ...
            jQuery('#tabla').DataTable({
                ...
                columns: [
                    ...
                    {data: "user_from_name", name: "user_from_name", className: "text-center"},
                    {data: "user_to_name", name: "user_to_name", className: "text-center"},
